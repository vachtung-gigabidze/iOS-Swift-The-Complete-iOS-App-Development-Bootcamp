...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String){
        switch userChoice {
        case stories[storyNumber].choice1: storyNumber = stories[storyNumber].choice1Destination
        case stories[storyNumber].choice2: storyNumber = stories[storyNumber].choice2Destination
            default: storyNumber = 0
        }       
